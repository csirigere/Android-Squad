...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.gold), 65, 25, 1);
    ...
    public void update()
    {
        if(player.getPlaying()) {
            ...
            if(missileElapsed >(2000 - player.getScore()/4)){
                ...
                if(missiles.size()==0)
                {
                    missiles.add(new Missile(BitmapFactory.decodeResource(getResources(),R.drawable.
                            mouth),WIDTH + 10, HEIGHT/2, 45, 30, player.getScore(), 1));
                }
                else
                {

                    missiles.add(new Missile(BitmapFactory.decodeResource(getResources(),R.drawable.mouth),
                            WIDTH+10, (int)(rand.nextDouble()*(HEIGHT - (maxBorderHeight * 2))+maxBorderHeight),45,30, player.getScore(),1));
                }
            ...
            if(!reset)
            {
                ...
                reset = true;
                dissapear = true;
                explosion = new Explosion(BitmapFactory.decodeResource(getResources(),R.drawable.jason),player.getX(),
                        player.getY()-30, 100, 100, 1);
            }
    ...
    public void drawText(Canvas canvas)
    {
        ...
        if(!player.getPlaying()&&newGameCreated&&reset)
        {
            ...
            canvas.drawText("DON'T LET JASON'S", WIDTH/2-50, HEIGHT/2, paint1);
            canvas.drawText("MOUTH TOUCH THE", WIDTH/2-50, HEIGHT/2 + 40, paint1);
            canvas.drawText("BOTTLE", WIDTH/2-50, HEIGHT/2 + 80, paint1);
            canvas.drawText("PRESS TO START", WIDTH/2-50, HEIGHT/2 + 120, paint1);

            paint1.setTextSize(20);
            canvas.drawText("PRESS AND HOLD TO GO UP", WIDTH/2-50, HEIGHT/2 + 140, paint1);
            canvas.drawText("RELEASE TO GO DOWN", WIDTH/2-50, HEIGHT/2 + 160, paint1);
        }
    }
}